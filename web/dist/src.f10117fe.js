...
var userForm = new UserForms_1.UserForm(document.getElementById('root'));
userForm.render(); // import { User } from './models/User';
...
// console.log(user);
},{"./views/UserForms":"src/views/UserForms.ts"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
